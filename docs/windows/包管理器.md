...
```powershell
irm https://gh.llkk.cc/https://raw.githubusercontent.com/firestrongarch/scoop-cn/master/install.ps1 | iex
```
...
git -C "$env:USERPROFILE\scoop\buckets\scoop-cn" remote set-url origin https://gh.llkk.cc/https://github.com/firestrongarch/scoop-cn
```
## 三、可视化界面
